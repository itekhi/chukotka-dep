...
import { type DocumentViewServerProps, type Where } from 'payload'
import { formatAdminURL, hasDraftsEnabled, isNumber } from 'payload/shared'
import React from 'react'

import { fetchLatestVersion, fetchVersions } from '../AdminCustomVersionView/fetchVersions'
...
export default async function VersionsView(props: DocumentViewServerProps) {
  ...
  const columns = buildVersionColumns({
    collectionConfig,
    CreatedAtCellOverride: undefined,
