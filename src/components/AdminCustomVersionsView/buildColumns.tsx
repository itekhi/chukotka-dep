...
import { UpdatedByCell } from './cells/UpdatedBy'
...
export const buildVersionColumns = ({
  ...
  columns.push({
    ...
    Heading: <SortColumn disable Label={'Обновлено'} name="updatedBy" />,
    renderedCells: docs.map((doc, i) => {
      const updatedBy = doc.version.updatedBy
      return <UpdatedByCell key={i} user={updatedBy} />
    }),
  })
